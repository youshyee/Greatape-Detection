...
tcmode='mode1' #mode 1 sliding window || mode2 snip_size=2n+1 if reduce must be this mode || mode3 any fit
use_train_multiscale=True
use_train_img_aug= True
dataset_repeat_mode_test=False
dataset_repeat_mode_train=False
work_dir = './workdir/chimp_retina_r50'
load_from = './workdir/slurm_v_retinanet_r50_fpn/epoch_16.pth'
