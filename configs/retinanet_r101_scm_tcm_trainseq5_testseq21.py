...
work_dir = './workdir/chimp/retinanet_r101/tcm_scm'
load_from = './workdir/slurm_v_retinanet_r101_vanilla/epoch_7.pth'

#####################################
if True: #fold this static setting
    input_scale_train=[(800, 350),(800,500)] if use_train_multiscale else (800, 500)
    aug=dict(
            type='Compose',
